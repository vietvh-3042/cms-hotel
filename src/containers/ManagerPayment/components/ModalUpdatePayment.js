...
ModalUpdatePayment.propTypes = {
	handleUpdatePayment: PropTypes.func,
};

ModalUpdatePayment.defaultProps = {
	handleUpdatePayment: null,
};

function ModalUpdatePayment(props) {
	const { visible, handleUpdatePayment } = props;
		...
		>
			<div className="relative">
				<div className="modal_header_action flex items-center">
					...
					/>
					<span>Chỉnh sửa phiếu chi phí</span>
				</div>
