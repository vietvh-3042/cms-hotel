...
function ModalFlexibleCustom(props) {
    ...
    const value = visibleCustom.detail;
    ...
    function handleSubmit(data) {
        ...
        getFlexiblePriceCustom(convert);
    ...
    function handeOnChange(val, setFieldValue) {
        ...
        if (val === "") {
            ...
            setFieldValue("additional_overtime_checkout_day", [{ time: "1", amount: "50000" }]);
            setFieldValue("additional_overtime_checkout_night", [{ time: "1", amount: "50000" }]);
            setFieldValue("additional_checkin_soon_day", [{ time: "1", amount: "50000" }]);
            setFieldValue("additional_checkin_soon_night", [{ time: "1", amount: "50000" }]);
                            ...
                            <Form>
                                <div className="flex">
                                    <div className="w-4/12">
                                        ...
                                        <div className="mb-2 flex items-center">
                                            <div className="LabelCo">Thời gian chạy:</div>
                                            <RangePicker
                                                name="date_in"
